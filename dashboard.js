026-03-18","orders":31,"revenue":3230.40},{"date":"2026-03-19","orders":33,"revenue":3898.31},{"date":"2026-03-20","orders":44,"revenue":3865.31},{"date":"2026-03-21","orders":46,"revenue":4690.18},{"date":"2026-03-22","orders":55,"revenue":6009.94},{"date":"2026-03-23","orders":55,"revenue":5140.08},{"date":"2026-03-24","orders":35,"revenue":3658.34},{"date":"2026-03-25","orders":49,"revenue":5205.03},{"date":"2026-03-26","orders":31,"revenue":3322.39},{"date":"2026-03-27","orders":44,"revenue":4499.26},{"date":"2026-03-28","orders":53,"revenue":4550.10},{"date":"2026-03-29","orders":51,"revenue":5478.10},{"date":"2026-03-30","orders":49,"revenue":4966.25},{"date":"2026-03-31","orders":39,"revenue":3975.35},{"date":"2026-04-01","orders":38,"revenue":4366.33},{"date":"2026-04-02","orders":48,"revenue":4656.21},{"date":"2026-04-03","orders":41,"revenue":3935.32},{"date":"2026-04-04","orders":37,"revenue":3864.38},{"date":"2026-04-05","orders":52,"revenue":5229.10},{"date":"2026-04-06","orders":53,"revenue":5080.13},{"date":"2026-04-07","orders":33,"revenue":3649.41},{"date":"2026-04-08","orders":41,"revenue":4505.24},{"date":"2026-04-09","orders":34,"revenue":335.96}];
...
function renderOverview() {
  ...
  summaryHtml += 'Over this ' + numDays + '-day period, HangSmart generated an estimated <strong>' + fmtN(totalEstUnits) + ' total units</strong> across all sales channels with <strong>' + fmt(totalRevenue) + ' in HangSmart net revenue</strong> (Shopify at actual SKU-level retail pricing, Amazon at $18.50/unit wholesale, Walmart at $19/unit wholesale). ';
  ...
  attrHtml += '<p style="color:var(--muted);margin:8px 0 16px">Monthly correlation between total ad spend and GA4 transactions across all platforms (Apr 2024 - Apr 2026)</p>';

  // Build monthly table
  var organicFloor = 460;
  attrHtml += '<table><thead><tr><th>Month</th><th style="text-align:right">Total Ad Spend</th><th style="text-align:right">GA4 Transactions</th><th style="text-align:right">Spend vs Prev</th><th style="text-align:right">Tx vs Prev</th><th style="text-align:right">Est. Organic</th><th style="text-align:right">Est. Paid</th></tr></thead><tbody>';
  var prev = null;
  MONTHLY_HISTORY.forEach(function(m) {
    ...
    var txChg = prev ? ((m.ga4_transactions - prev.tx) / prev.tx * 100).toFixed(1) : '-';
    var organicPct = m.ga4_transactions > 0 ? Math.min(100, (organicFloor / m.ga4_transactions * 100)).toFixed(1) : '0.0';
    var paidPct = (100 - parseFloat(organicPct)).toFixed(1);
    var spendColor = spendChg !== '-' ? (parseFloat(spendChg) >= 0 ? 'var(--green)' : 'var(--red)') : 'inherit';
    var txColor = txChg !== '-' ? (parseFloat(txChg) >= 0 ? 'var(--green)' : 'var(--red)') : 'inherit';
    attrHtml += '<tr><td style="font-weight:600">' + m.month + '</td>';
    attrHtml += '<td style="text-align:right">' + fmt(totalSpend) + '</td>';
    attrHtml += '<td style="text-align:right">' + fmtN(m.ga4_transactions) + '</td>';
    attrHtml += '<td style="text-align:right;color:' + spendColor + '">' + (spendChg !== '-' ? spendChg + '%' : '-') + '</td>';
    attrHtml += '<td style="text-align:right;color:' + txColor + '">' + (txChg !== '-' ? txChg + '%' : '-') + '</td>';
    attrHtml += '<td style="text-align:right;color:var(--muted)">' + organicPct + '%</td>';
    attrHtml += '<td style="text-align:right;color:var(--gold)">' + paidPct + '%</td></tr>';
    prev = {spend: totalSpend, tx: m.ga4_transactions};
  });
  attrHtml += '</tbody></table>';

  // Key insights
  var recentMonths = MONTHLY_HISTORY.filter(function(m) { return m.month >= '2025-11'; });
  var totalRecentSpend = 0, totalRecentTx = 0;
  recentMonths.forEach(function(m) { totalRecentSpend += m.fb_spend + m.gads_spend + m.tt_spend + m.vibe_spend; totalRecentTx += m.ga4_transactions; });
  var avgMonthlySpend = totalRecentSpend / recentMonths.length;
  var avgMonthlyTx = totalRecentTx / recentMonths.length;
  var avgPaidPct = (100 - (organicFloor / avgMonthlyTx * 100)).toFixed(1);
  ...
  attrHtml += '- <strong>Organic baseline:</strong> ~460 transactions/month (derived from Feb-Mar 2025 when spend dropped to ~$20K-$22K/month)<br>';
  attrHtml += '- <strong>Recent 5-month avg:</strong> ' + fmt(avgMonthlySpend) + '/month spend driving ~' + fmtN(Math.round(avgMonthlyTx)) + ' transactions/month<br>';
  attrHtml += '- <strong>Est. paid contribution:</strong> ~' + avgPaidPct + '% of transactions are ad-driven<br>';
  ...
  attrHtml += '- <strong>Remember:</strong> GA4 only tracks Shopify (direct site sales). Amazon and Walmart sales are NOT in these numbers. Multiply by ~2.5x for true blended unit estimate.';
  attrHtml += '</div>';
...
function renderDailyBlended(dates) {
  ...
  dates.forEach(function(d) {
    ...
    var rev = (shop ? shop.revenue : 0) + (amz.units * 18.50) + (wmt.total_units * 19);
...
function renderShopify() {
  ...
  html += '<div class="card"><h3>Net Revenue</h3><div class="value">' + fmt(estRevenue) + '</div></div>';
  ...
  var dHtml = '<table><thead><tr><th>Date</th><th>Day</th><th style="text-align:right">Orders</th><th style="text-align:right">Net Revenue</th><th style="text-align:right">Avg Order Value</th></tr></thead><tbody>';
  shop.forEach(function(r) {
    var aov = r.orders > 0 ? (r.revenue / r.orders).toFixed(2) : '0.00';
    dHtml += '<tr><td style="font-weight:600">' + fmtDate(r.date) + '</td><td>' + getDayShort(r.date) + '</td>';
    dHtml += '<td style="text-align:right;font-weight:600">' + r.orders + '</td>';
    dHtml += '<td style="text-align:right">' + fmt(r.revenue) + '</td>';
    dHtml += '<td style="text-align:right;color:var(--muted)">' + fmt(parseFloat(aov)) + '</td></tr>';
  });
  dHtml += '</tbody></table>';
